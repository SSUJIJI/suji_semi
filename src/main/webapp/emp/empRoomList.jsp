		...
		<div class="row">
			...
			<div class="col-10">
				<div class="w-75 p-3 border border-warning rounded-pill shadow p-3 bg-body-tertiary rounded">
					<form method="post" action="/BeeNb/emp/empRoomList.jsp" onsubmit="return validateForm()">
						<%
							if(lowPrice!=null){
						%>
		...
		<ul class="nav justify-content-center">
			...
			<div class="dropdown">
			  ...
			  <ul class="dropdown-menu" style="width:500px;">
				<form method="post" action="/BeeNb/emp/empRoomList.jsp" onsubmit="return validateFilterForm()">
