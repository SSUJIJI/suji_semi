...
public class ComplainDAO {
	...
	public static HashMap<String, String> selectComplainOne(String complainNo) throws Exception {
	...
	// 호출 : vocList.jsp
	// return : ArrayList<HashMap<String, Object>>
	public static ArrayList<HashMap<String, Object>> selectVOCList(String complainState, int startRow, int rowPerPage) throws Exception{
		...
		String sql = "SELECT "
				+ "c.complain_no complainNo, "
				+ "c.complain_type complainType, "
				+ "c.complain_content complainContent, "
				+ "c.complain_state complainState, "
				+ "c.complain_answer complainAnswer, "
